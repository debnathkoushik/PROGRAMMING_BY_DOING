...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		System.out.print(j(5));    // returns a different word depending on what you pass it (1-3)
		...
		x(5);    // returns a different word depending on what you pass it (1-2)
	...
	public static void c(boolean TRUE)
	{
		if ( TRUE )
	...
	public static void i(int ignoredparameter)
	{
       ...
       // System.out.print((char) ignoredparameter);
